...
!
!svn $Id: nl_ocean.h 900 2018-03-21 03:23:08Z arango $
!================================================== Hernan G. Arango ===
...
# ifdef C_COUPLER
      USE coupling_roms_mod, ONLY : register_component_coupling_configuration,run_coupling     !zhaobiao, c-coupler2
# endif
...
# ifdef C_COUPLER
      integer :: ig, il,tile                                                           !zhaobiao, c-coupler2
# endif
...
# ifdef C_COUPLER
      ...
      DO ig=1, GridsInLayer(il)
         ng=GridNumber(ig,il)
         CALL register_component_coupling_configuration (ng, il-1, MyRank)    !zhaobiao, c-coupler2
         DO tile=last_tile(ng),first_tile(ng),-1
              CALL run_coupling(ng, tile)
          END DO
      END DO
      END DO
# endif
...
!
      ...
      USE mod_scalars
# ifdef C_COUPLER
      USE coupling_roms_mod, ONLY : release_roms_buf     !zhaobiao, c-coupler2
# endif
!
!  Local variable declarations.
!
...
# ifdef C_COUPLER
          CALL release_roms_buf(ng)                !zhaobiao, c-coupler2
# endif
        END DO
!$OMP END PARALLEL
      END DO
