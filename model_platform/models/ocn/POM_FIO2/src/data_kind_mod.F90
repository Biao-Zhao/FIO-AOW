!======================================================================
!CVS: $Id: data_kind_mod.F90,v 1.1 2013/06/17 12:35:58 wgs Exp $
!CVS: $Source: /soa04/users/wgs/.mycvsroot/intercomm/ocean/data_kind_mod.F90,v $
!CVS: $Name:  $
!======================================================================
MODULE data_kind_mod
   ...
   !integer,parameter :: KIND_R4 = selected_real_kind(12) ! 4 byte real
